...
const ContentBuilder: React.FC = () => {
  ...
  const handleGenerateContent = async () => {
    if (
      ...
      !generateOptions.contentType ||
      !generateOptions.tone
    ) {
      toast({
    ...
    try {
      ...
      if (response.content) {
        ...
        toast({
          ...
          description:
            "AI has successfully generated content based on your prompt",
        });
      }
    } catch (error) {
      ...
      toast({
        ...
        description:
          "There was a problem generating content. Please try again.",
        variant: "destructive",
      });
    } finally {
        ...
        <CardContent>
          ...
          >
              ...
              <div className="grid gap-4">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="email">
                        {t("admin.emailCampaign")}
                      </SelectItem>
                      <SelectItem value="product">
                        {t("admin.productDescription")}
                      </SelectItem>
                      <SelectItem value="social">
                        {t("admin.socialMediaPost")}
                      </SelectItem>
                      <SelectItem value="headline">
                        {t("admin.headline")}
                      </SelectItem>
                      <SelectItem value="ad">
                        {t("admin.advertisementCopy")}
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div className="grid gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setGenerateOptions({ ...generateOptions, tone: value })
                    }
                  >
                    <SelectTrigger>
            ...
            <TabsContent value="analyze" className="space-y-4">
              <div className="grid gap-4">
                <div className="grid gap-2">
                  <Label htmlFor="textToAnalyze">
                    {t("admin.textToAnalyze")}
                  </Label>
                  <Textarea
                    id="textToAnalyze"
                    value={textToAnalyze}
