                ...
                <div className="grid gap-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="show-header-nav">
                      {t("admin.showNavigationInHeader")}
                    </Label>
                  </div>
                </div>
              </div>
