  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gradient-to-b from-background to-slate-50 dark:from-background dark:to-slate-950">
      ...
      <div className="w-full md:w-3/5 flex items-center justify-center p-4 sm:p-8 md:p-12 lg:p-16 xl:p-20">
        <div className="w-full max-w-md xl:max-w-xl backdrop-blur-sm bg-white/80 dark:bg-slate-900/80 p-6 sm:p-8 xl:p-10 rounded-xl shadow-lg border border-gray-200 dark:border-gray-800">
      ...
      <div className="hidden lg:flex w-2/5 bg-auth-gradient text-white p-8 xl:p-12 2xl:p-16 flex-col justify-center relative overflow-hidden">
        ...
        <div className="max-w-xl xl:max-w-2xl mx-auto relative z-10">
          <div className="flex items-center mb-6 md:mb-8">
            <Bot className="h-10 w-10 xl:h-12 xl:w-12 text-white/80 mr-4" />
            <h2 className="text-3xl sm:text-4xl xl:text-5xl font-heading font-bold">
              {t("auth.hero.title")}
            </h2>
          </div>
          <p className="text-primary-100 text-base sm:text-lg xl:text-xl xl:leading-relaxed mb-8 md:mb-10">
            {t("auth.hero.description")}
          </p>

          <div className="space-y-6 xl:space-y-8 xl:grid xl:grid-cols-2 xl:gap-x-8 xl:gap-y-8 text-primary-100">
            <div className="flex items-start">
              <div className="w-10 h-10 sm:w-12 sm:h-12 xl:w-14 xl:h-14 bg-white/20 rounded-full flex items-center justify-center mr-4 mt-1 flex-shrink-0 shadow-glow transition-transform hover:scale-105">
                <Bot className="h-5 w-5 sm:h-6 sm:w-6 xl:h-7 xl:w-7 text-white" />
              </div>
              <div>
                <h3 className="text-lg sm:text-xl xl:text-2xl font-medium text-white mb-1">
            ...
            <div className="flex items-start">
              <div className="w-10 h-10 sm:w-12 sm:h-12 xl:w-14 xl:h-14 bg-white/20 rounded-full flex items-center justify-center mr-4 mt-1 flex-shrink-0 shadow-glow transition-transform hover:scale-105">
                <ShieldCheck className="h-5 w-5 sm:h-6 sm:w-6 xl:h-7 xl:w-7 text-white" />
              </div>
              <div>
                <h3 className="text-lg sm:text-xl xl:text-2xl font-medium text-white mb-1">
            ...
            <div className="flex items-start">
              <div className="w-10 h-10 sm:w-12 sm:h-12 xl:w-14 xl:h-14 bg-white/20 rounded-full flex items-center justify-center mr-4 mt-1 flex-shrink-0 shadow-glow transition-transform hover:scale-105">
                <Zap className="h-5 w-5 sm:h-6 sm:w-6 xl:h-7 xl:w-7 text-white" />
              </div>
              <div>
                <h3 className="text-lg sm:text-xl xl:text-2xl font-medium text-white mb-1">
            ...
            <div className="flex items-start">
              <div className="w-10 h-10 sm:w-12 sm:h-12 xl:w-14 xl:h-14 bg-white/20 rounded-full flex items-center justify-center mr-4 mt-1 flex-shrink-0 shadow-glow transition-transform hover:scale-105">
                <PlugZap className="h-5 w-5 sm:h-6 sm:w-6 xl:h-7 xl:w-7 text-white" />
              </div>
              <div>
                <h3 className="text-lg sm:text-xl xl:text-2xl font-medium text-white mb-1">
