...
export class AgentExecutionService {
  ...
  private async executeAIAssistant(context: AgentTaskContext): Promise<AgentTaskResult> {
    try {
  ...
  private async executeDataProcessor(context: AgentTaskContext): Promise<AgentTaskResult> {
  ...
  private async executeWebScraper(context: AgentTaskContext): Promise<AgentTaskResult> {
  ...
  private async executeFileAnalyzer(context: AgentTaskContext): Promise<AgentTaskResult> {
    try {
...
export async function createAgentTask(agentId: number, title: string, description?: string | null): Promise<Task> {
